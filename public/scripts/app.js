...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webpack_zepto = __webpack_require__(3);
	
	var _webpack_zepto2 = _interopRequireDefault(_webpack_zepto);
	
	__webpack_require__(4);
	
	var _exclaimify = __webpack_require__(7);
	...
	(0, _webpack_zepto2['default'])('#button').on('click', function () {
	   alert('hihi');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loop = function () {
	  ...
	  __webpack_require__.e/* nsure */(1, function () {
	    var Module = __webpack_require__(5)("./" + name);
	    new Module(el);
	  });
	};
